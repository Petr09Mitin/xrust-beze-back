...
type StudyMaterialServer struct {
	...
	service study_material_service.StudyMaterialAPIService
	logger  zerolog.Logger
}

func NewStudyMaterialServer(service study_material_service.StudyMaterialAPIService, logger zerolog.Logger) *StudyMaterialServer {
