...
func NewStudyMaterialRepository(db *mongo.Database, logger zerolog.Logger) StudyMaterialRepo {
...
func (r *studyMaterialRepository) GetByID(ctx context.Context, id string) (*study_material_models.StudyMaterial, error) {
...
func (r *studyMaterialRepository) GetByTags(ctx context.Context, tags []string) ([]*study_material_models.StudyMaterial, error) {
	// filter := bson.M{"tags": tag}
	filter := bson.M{"tags": bson.M{"$in": tags}}
	return r.find(ctx, filter)
}

func (r *studyMaterialRepository) GetByName(ctx context.Context, name string) ([]*study_material_models.StudyMaterial, error) {
...
func (r *studyMaterialRepository) GetByAuthorID(ctx context.Context, authorID string) ([]*study_material_models.StudyMaterial, error) {
...
func (r *studyMaterialRepository) Delete(ctx context.Context, materialID string) error {
...
func (r *studyMaterialRepository) find(ctx context.Context, filter interface{}) ([]*study_material_models.StudyMaterial, error) {
