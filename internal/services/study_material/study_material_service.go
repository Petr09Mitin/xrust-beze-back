...
func (s *studyMaterialService) GetByID(ctx context.Context, id string) (*study_material_models.StudyMaterial, error) {
...
func (s *studyMaterialService) GetByTags(ctx context.Context, tags []string) ([]*study_material_models.StudyMaterial, error) {
...
func (s *studyMaterialService) GetByName(ctx context.Context, name string) ([]*study_material_models.StudyMaterial, error) {
...
func (s *studyMaterialService) GetByAuthorID(ctx context.Context, authorID string) ([]*study_material_models.StudyMaterial, error) {
...
func (s *studyMaterialService) Delete(ctx context.Context, materialID string, userID string) error {
...
func (s *studyMaterialService) fillAuthorInfo(ctx context.Context, mat *study_material_models.StudyMaterial) {
...
func (s *studyMaterialService) addAuthorsInfo(ctx context.Context, materials []*study_material_models.StudyMaterial) ([]*study_material_models.StudyMaterial, error) {
	if len(materials) == 0 {
