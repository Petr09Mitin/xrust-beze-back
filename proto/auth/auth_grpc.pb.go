...
func (c *authServiceClient) ValidateSession(ctx context.Context, in *SessionRequest, opts ...grpc.CallOption) (*SessionResponse, error) {
...
func (UnimplementedAuthServiceServer) ValidateSession(context.Context, *SessionRequest) (*SessionResponse, error) {
...
func _AuthService_ValidateSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ValidateSession(ctx, req.(*SessionRequest))
	}
